...
new_note_abs_path = " ".join(
    daily_notes_dir_parts
)  # TODO: what happens if you join a list of 1 items with a space
    ...
    while True:
        ...
        try:
            file_path = os.path.join(
                daily_notes_dir, prev_day_year, prev_day_month, file_name
            )
            ...
            with open(file_path, "r+") as f:
                ...
                for line in lines:
                    ...
                    if match(unchecked, line):
                        ...
                        if not match(empty_todo, line) and not match(
                            empty_bullet, line
                        ):
